...
module.exports = kconfig = async (kill, message) => {
	...
	try {
		...
		let stckPack = (removeAccents(config.Sticker_Pack).toString() || "🔰 Horizon Z [bit.ly/BOT-yui] Yui ⚜️")
		...
		const errorImg = 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/user.png'
		...
		for (let i = 0; i < multiCommand.length; i++) {
			...
			switch (cmd) {
				...
				case 'about':
					await kill.sendFileFromUrl(from, 'https://s6.gifyu.com/images/img-yui.jpg', 'yui.png', mess.about(), id)
				...
				case 'horizon':
					if (isGroupMsg) return await kill.reply(from, mess.sopv(), id)
					await kill.sendLinkWithAutoPreview(from, 'https://chat.whatsapp.com/Hop7HMRAipPLX1Pr0aD8yx', mess.onlyRecLz())
				break
				...
				case 'roleta':
					...
					if (side == 1) {
						await kill.sendFileFromUrl(from, 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/roleta1.png', 'rol1.png', mess.loseshot(iRoll), id)
						...
						await kill.sendFileFromUrl(from, 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/roleta.jpg', 'rol.jpg', mess.winshot(iRoll), id)
						tools('gaming').addValue(sender.id, Number(iRoll), nivel, chatId, 'coin')
					}
				...
				case 'flip':
					...
					if (argl[0] == 'cara' && side == 1 || argl[0] == 'coroa' && side == 2) {
						let winFlipURL = side == 1 ? 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/heads.png' : 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/tails.png'
				...
				/*LEMBRE-SE, REMOVER CRÈDITO È CRIME E PROIBIDO!*/
				//case 'termos':
					//await kill.sendFileFromUrl(from, 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/license.png', 'licenca.png', mess.everhost() + '\n\n' + mess.tos(), id)
					...
					if (gameconfig[chatId]['forcw'] == 0 || argl[0] == '-new') {
						...
						if (awnserFind == 1) {
							...
							if (gameconfig[chatId]['lives'] == 5) {
								await mandarFig('https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/1.png')
							} else if (gameconfig[chatId]['lives'] == 4) {
								await mandarFig('https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/2.png')
							} else if (gameconfig[chatId]['lives'] == 3) {
								await mandarFig('https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/3.png')
							} else if (gameconfig[chatId]['lives'] == 2) {
								await mandarFig('https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/4.png')
							} else if (gameconfig[chatId]['lives'] == 1) {
								await mandarFig('https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/5.png')
							} else if (gameconfig[chatId]['lives'] == 0) {
								await kill.sendFileFromUrl(from, 'https://raw.githubusercontent.com/Pyon/yui_Files/main/Assets/6.jpg', 'lose.jpg', `Você perdeu! Não encontrei a letra "${argl[1].split('')[0].toUpperCase()}"\n\nA palavra era "${gameconfig[chatId]['forcw'].toUpperCase()}"`, id)
								return resetForca()
							}
				...
				case 'genshin':
					...
					if (argl[0] == '-sets') {
						let charList = await axios.get('https://raw.githubusercontent.com/Pyon/yui_Files/main/Genshin/sets.txt')
						...
						await kill.sendFileFromUrl(from, `https://github.com/Pyon/yui_Files/raw/main/Genshin/${charToSend}`, charToSend, `Esta é a melhor 'configuração' para ${argl[1]}.`, id)
					} else if (argl[0] == '-char') {
				...
				if (isGroupMsg) {
					...
					if (argl[0] == '-start' && bjConfig[chatId].isPlaying == false) {
						...
						await kill.sendStickerfromUrl(from, `https://github.com/Pyon/yui_Files/raw/main/Cards/${argc[1]}.png`, {
							method: 'get'
						}, stickerConfig)
						...
						if (checkWin > 21) {
							await kill.sendStickerfromUrl(from, `https://github.com/Pyon/yui_Files/raw/main/Cards/${newCard}.png`, {
								method: 'get'
							}, stickerConfig)
							...
							await kill.sendStickerfromUrl(sender.id, `https://github.com/Pyon/yui_Files/raw/main/Cards/${newCard}.png`, {
								method: 'get'
							}, stickerConfig)
				...
				case 'couple':
					...
					await kill.sendFileFromUrl(from, `https://github.com/Pyon/yui_Files/raw/main/Couple/${theCouple}.1.jpg`, 'couple.jpg', 'Você completa...', id)
					await kill.sendFileFromUrl(from, `https://github.com/Pyon/yui_Files/raw/main/Couple/${theCouple}.2.jpg`, 'couple.jpg', '...meu coração.', id)
				break
