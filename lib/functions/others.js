...
// Função que separa o "Sim" de cada língua da Yui
exports.yesAwnsers = () => config.Language == 'pt' ? 'Sim' : config.Language == 'en' ? 'Yes' : 'Si'

// Função que separa o "Não" de cada língua na Yui [eu sei, ambas são 'inúteis' :)]
...
exports.clearFile = (p, t = 10000, isDir = false) => {
	try {
		...
		console.log(error, '\nTalvez você não tenha permissão de edição, tente mudar o local da pasta da Yui ou rodar como administrador.')
	}
}