...
exports.options = (restart, sesname, folderSes) => {
	...
	// Ativa a pasta de sessão da Yui no local desejado
	...
	// Desliga a Yui em casos de timeout
	...
	// Manda os valores finais para a config.js e cria uma sessão da Yui
	return startOptions
