...
exports.bolso1 = async (canvaimage) => {
	...
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/bolsonaro/template.png")
...
exports.bolso2 = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/bolso_frame/template.png")
...
exports.bolso3 = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/bolsonaro2/template.png")
	let frame = await canvas.loadImage(canvaimage)
	let bolsoCanvas = canvas.createCanvas(bg.width, bg.height)
	let ctx = bolsoCanvas.getContext("2d")
...
exports.sponge = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/bob_burning_paper/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.briggs = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/briggs_cover/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.ednaldoBandeira = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/ednaldo_bandeira/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.ednaldoTV = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/ednaldo_tv/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.markSuckerberg = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/mark_meta/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.paper = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/passing_paper/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.pepe = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/pepe_dream/template.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.shotTV = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/rip_tv/rip_tv_og.png")
	let frame = await canvas.loadImage(canvaimage)
...
exports.romero = async (canvaimage) => {
	...
	let blurredBG = await canvas.loadImage(blurredSharpBG)
	let bg = await canvas.loadImage("https://raw.githubusercontent.com/KillovSky/yui_Files/main/Memes/romero_britto/template.png")
	let frame = await canvas.loadImage(canvaimage)
